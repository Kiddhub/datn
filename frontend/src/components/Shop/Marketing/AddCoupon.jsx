...
const defaultValues =
{
    ...
    discountType: "",
    quantity: 0,
    timeStart: "", // Chỉnh sửa giá trị mặc định cho time_start
    timeEnd: "",   // Chỉnh sửa giá trị mặc định cho time_end
}
const AddCoupon = () => {
    ...
    const onSubmit = async (data) => {
        console.log(data);
        try{
            const res = await postFetch('shop/coupon/new',data,token)
            navigate('/shop/coupon', {
                state: {
                  showAlert: true,
                  alertSeverity: "success",
                  alertMessage: "Thêm mã thành công",
                },
              });
        }catch(err){
            console.error(err)
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            ...
                            >
                                ...
                                <MenuItem value='VNĐ'>VND</MenuItem>
                            </Select>
                        )}
                    />
                    {/* Number Field */}
